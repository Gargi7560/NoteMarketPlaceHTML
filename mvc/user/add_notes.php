        ...
        if(isset($_POST['title'],$_POST['catType'],$_POST['selectType'],$_POST['numPage'],$_POST['description'],$_POST['country'],$_POST['insName'],$_POST['courseName'],$_POST['courseCode'],$_POST['ProfName'],$_POST['sellFor'],$_POST['sellPrice'])) {
            ...
            if($current_note_id == 0){
                ...
                if(!empty($current_note_id)){
                    ...
                    $note_edit_link = "http://$_SERVER[HTTP_HOST]".dirname($_SERVER['PHP_SELF'])."/add_notes.php?note_id=" . $current_note_id;
        ...
        function updateNoteStatus(noteID) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    window.location.href = "http://localhost/PHP_NoteMarketPlace/user/user_dashboard-1.php";
                }
            });
        }
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-common">
                                    ...
                                    <?php 
                                        if($current_note_id != 0 && !empty($note_detail_result[0]["DisplayPicture"]) && $note_detail_result[0]["DisplayPicture"] > 0){
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-common" id="big_text_area">
                                    ...
                                    <textarea class="form-control input_val" id="description" rows="5" name="description" placeholder="Enter your description" onblur="validateDescription();">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-common">
                                    ...
                                    <?php 
                                        if($current_note_id != 0 && !empty($note_detail_result[0]["CourseCode"]) && $note_detail_result[0]["CourseCode"] > 0){
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-common">
                                    ...
                                    <input type="file" class="form-control input_val" id="notePre" name="notePre">
                                    <label class="picture_bottom_note">Upload a picture</label>
                                    <?php 
                                        if($current_note_id != 0 && !empty($note_detail_result[0]["NotesPreview"]) && $note_detail_result[0]["NotesPreview"] > 0){
