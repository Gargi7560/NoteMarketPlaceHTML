    ...
    if(isset($_REQUEST['submit'])) {
        ...
        unset($validate);
            ...
            $body = "Hello, <br/><br/>";
                ...
                $message = "Thanks We will in touch";
                unset($_POST);
                } else {		    
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-common">
                            <label for="fname">First Name * </label>
                                <input type="text" class="form-control input_val" id="fname" name="fname" placeholder="Enter your first name" onblur="validateContactFirstName();">
                                    	
                                <span id="fnameVal" class="spnValMsg"></span>    
                        </div>
                        <div class="form-group form-common">
                            <label for="email">Email *</label>
                            <input type="text" class="form-control input_val" id="email" name="email" placeholder="Enter your email address" onblur="validateContactEmail();">
