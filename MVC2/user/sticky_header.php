            ...
            <div class="container">
                <div class="header-wrapper">
                    <div class="logo-wrapper">
                        <a class="navbar-brand" href="home_page.php"><img src="images/logo_pur/top-logo.png" alt="logo"></a> 
                                ...
                                <ul class="menu-navigation">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <img src="<?php 
                                            echo             str_replace($_SERVER["DOCUMENT_ROOT"], $http_protocol.$_SERVER["HTTP_HOST"], $_SESSION['profile_pic']);
                        ...
                        <div id="mobile-nav-content">
                           <ul class="menu-navigation">
                               ...
                               <li class="dropdown">
                                   ...
                                   <a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                       <img src="<?php 
                                            echo             str_replace($_SERVER["DOCUMENT_ROOT"], $http_protocol.$_SERVER["HTTP_HOST"], $profileResult[0]["ProfilePicture"]);
                                            ?>" alt="user" class="img-responsive">
                                   </a>
                                   <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                       <a class="dropdown-item" href="user_profile.php">My Profile</a>
