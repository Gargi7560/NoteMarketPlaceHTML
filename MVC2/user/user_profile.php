                        ...
                        <div class="row">
                                ...
                                <div class="form-group form-common">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 col-8">
                                            <input type="text" class="form-control input_val" id="phoneNo" name="phoneNo" <?php if($current_user_profile_id != 0 && !empty($user_detail_result[0]["PhoneNumber"]) && $user_detail_result[0]["PhoneNumber"] > 0){
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-common">
                                    ...
                                    <?php
                                    if($current_user_profile_id != 0 && !empty($user_detail_result[0]["ProfilePicture"]) && $user_detail_result[0]["ProfilePicture"] > 0){
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-common">
                                        ...
                                        <input type="zip" class="form-control input_val" id="zipCode" name="zipCode" placeholder="Enter your zipcode" <?php if($current_user_profile_id != 0 && !empty($user_detail_result[0]["ZipCode"]) && $user_detail_result[0]["ZipCode"] > 0){
